...
// Heavily modified from libogc's gu.h
 ...
 * \return none
 */
void C_MTXFrustum(Mtx44 mt,f32 t,f32 b,f32 l,f32 r,f32 n,f32 f);
 ...
 * \return none
 */
void C_MTXPerspective(Mtx44 mt,f32 fovy,f32 aspect,f32 n,f32 f);
 ...
 * \return none
 */
void C_MTXOrtho(Mtx44 mt,f32 t,f32 b,f32 l,f32 r,f32 n,f32 f);
 ...
 * \return none
 */
void C_MTXLookAt(Mtx mt,Vec *camPos,Vec *camUp,Vec *target);
 ...
 * \return none
 */
void guVecHalfAngle(Vec *a,Vec *b,Vec *half);

void c_guVecAdd(Vec *a,Vec *b,Vec *ab);
void c_guVecSub(Vec *a,Vec *b,Vec *ab);
void c_guVecScale(Vec *src,Vec *dst,f32 scale);
void c_guVecNormalize(Vec *v);
void c_guVecMultiply(Mtx mt,Vec *src,Vec *dst);
void c_guVecCross(Vec *a,Vec *b,Vec *axb);
void c_guVecMultiplySR(Mtx mt,Vec *src,Vec *dst);
f32 c_guVecDotProduct(Vec *a,Vec *b);

#ifdef GEKKO
void PSVECAdd(register Vec *a,register Vec *b,register Vec *ab);
void PSVECSubtract(register Vec *a,register Vec *b,register Vec *ab);
void PSVECScale(register Vec *src,register Vec *dst,f32 scale);
void PSVECNormalize(register Vec *src,register Vec *dst);
void PSVECCrossProduct(register Vec *a,register Vec *b,register Vec *axb);
void ps_guVecMultiply(register Mtx mt,register Vec *src,register Vec *dst);
void ps_guVecMultiplySR(register Mtx mt,register Vec *src,register Vec *dst);
...
void c_guMtxRotAxisRad(Mtx mt,Vec *axis,f32 rad);
void c_guMtxReflect(Mtx m,Vec *p,Vec *n);
void c_guMtxQuat(Mtx m,guQuaternion *a);

#ifdef GEKKO
void PSMTXIdentity(register Mtx mt);
...
void PSMTXScale(register Mtx mt,register f32 xS,register f32 yS,register f32 zS);
void PSMTXScaleApply(register Mtx src,register Mtx dst,register f32 xS,register f32 yS,register f32 zS);
void ps_guMtxApplyScale(register Mtx src,register Mtx dst,register f32 xS,register f32 yS,register f32 zS);
void PSMTXTrans(register Mtx mt,register f32 xT,register f32 yT,register f32 zT);
void PSMTXTransApply(register Mtx src,register Mtx dst,register f32 xT,register f32 yT,register f32 zT);
void ps_guMtxApplyTrans(register Mtx src,register Mtx dst,register f32 xT,register f32 yT,register f32 zT);
void PSMTXRotRad(register Mtx mt,register const char axis,register f32 rad);
void ps_guMtxRotTrig(register Mtx mt,register const char axis,register f32 sinA,register f32 cosA);
void PSMTXRotAxisRad(register Mtx mt,register Vec *axis,register f32 tmp0);
void ps_guMtxReflect(register Mtx m,register Vec *p,register Vec *n);
#endif	//GEKKO
...
#define MTXRotDeg(mt,axis,deg)		MTXRotRad(mt,axis,DegToRad(deg))
#define MTXRotAxisDeg(mt,axis,deg)	MTXRotAxisRad(mt,axis,DegToRad(deg))
